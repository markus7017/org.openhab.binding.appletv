...
class Playing:
	...
	def __str__(self):
		...
		pyatv_api.javaHandler.statusEvent("play_state", 
			str(convert.playstate_str(self.play_state)))
		...
		if self.repeat is not None:
			...
			pyatv_api.javaHandler.statusEvent("repeat",
				str(convert.repeat_str(self.repeat)))
